...
const OverviewAdmonition = ({ title, children }: AdmonitionProps) => {
  ...
  return (
    <div className="my-3 rounded-xl border bg-indigo-50 text-slate-700">
...
const NoteAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Note';
  return (
    <div className="my-3 rounded-xl border bg-sky-50 text-slate-700">
...
const ImportantAdmonition = ({ title, children }: AdmonitionProps) => {
  ...
  return (
    <div className="my-3 rounded-xl border bg-amber-50 text-slate-700">
...
const TipAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Tip';
  return (
    <div className="my-3 rounded-xl border bg-emerald-50 text-slate-700">
...
const WarningAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Warning';
  return (
    <div className="my-3 rounded-xl border bg-rose-50 text-slate-700">
...
const CommentAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Comment';
  return (
    <div className="my-3 rounded-xl border bg-neutral-50 text-slate-700">
...
const ExampleAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Example';
  return (
    <div className="my-3 rounded-xl border bg-violet-50 text-slate-700">
...
const QuoteAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Quote';
  return (
    <div className="my-3 rounded-xl border bg-teal-50 italic text-slate-700">
...
const QuestionAdmonition = ({ title, children }: AdmonitionProps) => {
  ...
  return (
    <div className="my-3 rounded-xl border bg-cyan-50 text-slate-700">
...
const SimpleAdmonition = ({ title, children }: AdmonitionProps) => {
  return (
    <div className="my-3 rounded-xl border bg-slate-50 text-slate-700">
      {title && (
        <>
